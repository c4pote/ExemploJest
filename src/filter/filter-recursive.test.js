...
it('filter([1, 2, 3, 2, 1, 5], (item, index, array) => index === array.indexOf(item)) should return  should return [1, 2, 3, 5]',() => {
    const before = filter([1, 2, 3, 5], (item, index, array) => index === array.indexOf(item))
